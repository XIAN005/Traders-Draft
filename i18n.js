...
const I18n = (() => {
  const dictionary = {
    fr: {
      ...
      capitalHelpText: "Le montant total disponible sur votre compte de trading. C'est la base de calcul de tous vos risques.",
      riskHelpText: "Le pourcentage de votre capital que vous acceptez de perdre si ce trade échoue. La règle d'or : ne jamais dépasser 1-2% par trade, même en cas de série de pertes.",
      entryHelpText: "Le prix auquel vous prévoyez d'ouvrir votre position (d'acheter ou de vendre).",
      slHelpText: "Le prix auquel votre position se fermera automatiquement en cas de perte, pour limiter les dégâts. C'est votre filet de sécurité — ne jamais trader sans en définir un.",
      tpHelpText: "Le prix auquel votre position se fermera automatiquement en cas de gain, pour sécuriser vos profits.",
      pipValueHelpText: "La valeur en dollars d'un mouvement de prix minimal (un pip ou un point), pour 1 lot/contrat standard. Pré-rempli automatiquement selon la paire choisie — modifiable si votre broker utilise une valeur différente.",
      leverageHelpText: "Optionnel. Le levier vous permet de contrôler une position plus grande que votre capital réel, mais amplifie aussi les pertes. Si vous débutez, il est plus prudent de laisser ce champ vide.",
      
      resPositionSize: "Taille de position",
      resRiskAmount: "Montant risqué",
      resPotentialProfit: "Profit potentiel",
      resRR: "Ratio R:R",
      resultsSummaryTemplate: "Vous ouvrirez une position de {size}, en risquant {risk} si le Stop Loss est touché, pour un gain potentiel de {profit} si le Take Profit est atteint — soit un ratio de {rr}.",
    ...
    en: {
      ...
      capitalHelpText: "The total amount available in your trading account. It's the base used to calculate all your risk.",
      riskHelpText: "The percentage of your capital you're willing to lose if this trade fails. Golden rule: never risk more than 1-2% per trade, even during a losing streak.",
      entryHelpText: "The price at which you plan to open your position (buy or sell).",
      slHelpText: "The price at which your position closes automatically if it moves against you, limiting the damage. This is your safety net — never trade without setting one.",
      tpHelpText: "The price at which your position closes automatically once it moves in your favor, locking in profit.",
      pipValueHelpText: "The dollar value of one minimum price move (a pip or a point), for 1 standard lot/contract. Auto-filled based on the pair you picked — editable if your broker uses a different value.",
      leverageHelpText: "Optional. Leverage lets you control a larger position than your actual capital, but it also amplifies losses. If you're just starting out, it's safer to leave this field empty.",
      
      resPositionSize: "Position Size",
      resRiskAmount: "Risk Amount",
      resPotentialProfit: "Potential Profit",
      resRR: "R:R Ratio",
      resultsSummaryTemplate: "You'll open a position of {size}, risking {risk} if the Stop Loss is hit, for a potential gain of {profit} if the Take Profit is reached — a {rr} ratio.",
